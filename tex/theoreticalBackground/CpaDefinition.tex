...
The CPA algorithm displayed in Algorithm~\ref{alg:CPA} uses an arbitrary CPA of this form to verify programs.
...
Afer initializing \reachedSet\ and \waitlistSet\ with the given sets $R_0$ and $W_0$, the following steps are repeated until \waitlistSet\ is empty:
...
The \valueAnalysisCPA\ \cite{Beyer2013} tracks integer values for all program variables with a known value explicitly.

...
The \symbolicValueAnalysisCPA\ (introduced in \cite{Lemberger2015} without dynamic precision adjustment) is an extension to the \valueAnalysisCPA. It introduces \emph{symbolic values} to handle non-deterministic values and expressions of unknown value.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{\ConstraintsCPA} \label{sec:constraintsCPA}

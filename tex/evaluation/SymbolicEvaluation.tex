...
\end{subfigure}
%\caption{CFA representing an example program CEGAR performs worse for than eager analysis.}
...
\end{table}
We compare three different techniques for computing interpolants of the \symbolicExecutionCPA\ already mentioned in Section~\ref{sec:newAssignmentRefinement}:
...
\paragraph*{With sliced prefix selection}
\begin{table}[t]
\centering
\begin{tabular}{|r|c|c|c|}
\hline

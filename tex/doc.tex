...
\newcommand{\refineExplicitFunc}{{\texttt{Refine}^V}}
\newcommand{\refineExplicit}[1]{\refineExplicitFunc(#1)}
\newcommand{\refineBoolFunc}{{\texttt{Refine}^\booleanset}}
\newcommand{\refineBool}[1]{\refineBoolFunc(#1)}
...
\newcommand{\interpolateBool}{{\interpolate^\booleanset}}
\newcommand{\interpolateExplicit}{{\interpolate^V}}
...
\newcommand{\valCPAPlus}{{\mathbb{C}_+}}
...
\title{Tuning symbolic execution in CPAchecker using CEGAR and other means}
\maketitle
